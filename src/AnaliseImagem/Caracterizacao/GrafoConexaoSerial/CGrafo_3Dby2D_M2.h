 ...
 * @ingroup  HCGrafo
*/
class CGrafo_3Dby2D_M2 : public CGrafo_3Dby2D {
// --------------------------------------------------------------Atributos
protected:
...
// -------------------------------------------------------------Construtor
     /// Construtor
     CGrafo_3Dby2D_M2 ( std::string _nomeArquivo ) : CGrafo_3Dby2D ( _nomeArquivo ),  rotInt ( nullptr ) {
          tipoGrafo  =  ETipoGrafo::grafo3DBy2D_M2 ;
     }

// --------------------------------------------------------------Destrutor
     /// Destrutor
     virtual ~ CGrafo_3Dby2D_M2 () = default;
...
// --------------------------------------------------------------------Set
// -----------------------------------------------------------------Friend
//       friend ostream& operator<< (ostream& os, CGrafo_3Dby2D_M2& obj);
//       friend istream& operator>> (istream& is, CGrafo_3Dby2D_M2& obj);
};

// -----------------------------------------------------------------Friend
// Declaração de Funções Friend
// ostream& operator<< (ostream& os, CGrafo_3Dby2D_M2& obj);
// istream& operator>> (istream& is, CGrafo_3Dby2D_M2& obj);
