 ...
 * Herdeira de CFEMorfologiaMatematica e CMatriz2D.
 */
class CFEMMIDF : public CFEMorfologiaMatematica, public CMatriz2D
{
// Atributos
protected:
...
public:
  ...
  CFEMMIDF (CMatriz2D * &matriz, unsigned int _tamanhoMascara = 3, unsigned int _raioMax = 32000);
  ...
  void CorrigeAbertura (CMatriz2D * &matriz, int &regiao);
/*
  /// Obtêm o raioMaximo
  unsigned int RaioMaximo ()
  {
	  return raioMaximo ;;
  }
*/  
