...
/**
 * @brief Calcula a distribuição de tamanho de poros e gargantas de imagens binárias ou de imagens em tons de cinza segmentadas pela classe CAberturaDilatacao3D.
