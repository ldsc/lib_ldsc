...
/*
CMatriz2D *CFEDCMarrHildreth::Go( CMatriz2D *& matriz, unsigned int _tamanhoMascara )
{
...
CMatriz2D *
CFEDCMarrHildreth::Go (CMatriz2D * &matriz, unsigned int _tamanhoMascara)
{
  ...
  CMatriz2D *pm2;		// matriz pm2 uma copia de pm

  pm2 = new CMatriz2D (*pm);	// im2 é uma copia de im1
...
void
CFEDCMarrHildreth::marr (float s, CMatriz2D * im)
{
  int width;
...
void
CFEDCMarrHildreth::convolution (CMatriz2D * im, float **mask, int nr, int nc,
...
void
CFEDCMarrHildreth::zero_cross (float **lapim, CMatriz2D * im)
{
  // int i,j,k,n,m, dx, dy;
  unsigned int i, j;
