#ifndef CObjetoRedePercolacao_Tipo_h
#define CObjetoRedePercolacao_Tipo_h
...
@file       CObjetoRedePercolacao_Tipo.h
...
// ===============================================================================
// Documentacao Classe: CObjetoRedePercolacao_Tipo
// ===============================================================================
/**
 ...
 * Comparar com CObjetoRedePercolacao_Final (que usa final de c++11).
 *
...
*/
class CObjetoRedePercolacao_Tipo : public CSolverMatriz_ParametroSolver  {
// --------------------------------------------------------------Atributos
public:
   /**
   ...
   */
   ...
   /**
   * @brief Vetor de ponteiros para objetos do tipo CObjetoRedePercolacao_Tipo.
   * Ou seja, ponteiros para objetos da hierarquia CObjetoRedePercolacao_Tipo.
   */
   std::vector < CObjetoRedePercolacao_Tipo* >conexao;
...
// -------------------------------------------------------------Construtor
/// Construtor
   CObjetoRedePercolacao_Tipo ( ETipoObjetoGrafo _tipo ) {
      tipo = _tipo;
   }

// --------------------------------------------------------------Destrutor
/// Destrutor
   /*virtual*/ ~ CObjetoRedePercolacao_Tipo () = default;
...
// ----------------------------------------------------------------Métodos
   ...
   /**
    * @brief Função que recebe um ponteiro para um CObjetoRedePercolacao objA e o inclue na lista de conexões.
   ...
   */
   inline void Conectar ( CObjetoRedePercolacao_Tipo* objA ) {
      this->conexao.push_back ( objA );
      this->condutancia.push_back ( objA->propriedade );
   }

   /**
   * @brief Função que recebe um ponteiro para um CObjetoRedePercolacao_Tipo objA e o inclue na lista de conexões.
   * Faz a conexão de this com o objeto recebido. Usada por objetos do tipo Sitio.
   * A condutância entre this e o objA é o segundo parâmetro (a _condutancia é calculada externamente).
   */
   inline void Conectar ( CObjetoRedePercolacao_Tipo* objA, long double _condutancia ) {
      this->conexao.push_back ( objA );
      this->condutancia.push_back ( _condutancia );
   }

   /**
   * @brief Função que recebe um ponteiro para um CObjetoRedePercolacao_Tipo objA e um ponteiro para um objeto B
   ...
   */
   /*inline */virtual void Conectar ( CObjetoRedePercolacao_Tipo* objA, CObjetoRedePercolacao_Tipo* objB ) {
      this->conexao.push_back ( objA );
      this->condutancia.push_back ( objA->propriedade );
   ...
   */
   /*inline */virtual void Conectar ( CObjetoRedePercolacao_Tipo* objA, long double _condutanciaA,
                                      CObjetoRedePercolacao_Tipo* objB , long double _condutanciaB ) {
      this->conexao.push_back ( objA );
...
// --------------------------------------------------------------------Get
   ...
   std::vector < CObjetoRedePercolacao_Tipo* > Conexao() const  {
      return conexao;
   }
...
// --------------------------------------------------------------------Set
   ...
   void Conexao ( std::vector < CObjetoRedePercolacao_Tipo* >  c ) {
      conexao = c;
   }
   ...
   // -----------------------------------------------------------------Friend
   friend std::ostream& operator<< ( std::ostream& os, CObjetoRedePercolacao_Tipo& obj );
//       friend istream& operator>> (istream& is, CObjetoRedePercolacao_Tipo& obj);

};

// -----------------------------------------------------------------Friend
// Declaração de Funções Friend
inline std::ostream& operator<< ( std::ostream& os, CObjetoRedePercolacao_Tipo& obj );
// istream& operator>> (istream& is, CObjetoRedePercolacao_Tipo& obj);

// Cria o tipo CObjetoRedePercolacao_Tipo_CENTER, que é igual a CObjetoRedePercolacao_Tipo
// typedef CObjetoRedePercolacao_Tipo CObjetoRedePercolacao_Tipo_CENTER;
// using CObjetoRedePercolacao_Tipo_CENTER = CObjetoRedePercolacao_Tipo;
