/**
  ...
  @file:             CObjetoRedePercolacao_Final.cpp
...
// -----------------------------------------------------------------------
#include <EstruturaDados/ObjetoRedePercolacao/CObjetoRedePercolacao_Final.h>
using namespace std;
...
/** Escreve os atributos do objeto em disco.
    ...
    Sobrecarga operador entrada streams (antiga CObjetoRedePercolacao_FinalEsqueleto).
    @author :	André Duarte Bueno
     
    @param  : 	ostream& e CObjetoRedePercolacao_Final&
    @return :		ostream&
*/
ostream& operator<< ( ostream& out, CObjetoRedePercolacao_Final& s )
{
   s.Write ( out );
   return out;
}
...
/** Sobrecarga operador entrada streams
    ...
    @param  : istream& is, CObjetoRedePercolacao_Final& s
    @return : istream&
*/

/*istream& operator>> (istream& is, CObjetoRedePercolacao_Final& s)
  {
...
/** A função Go calcula o novo valor de x, considerando o relacionamento
    ...
    @return : long double
*/
long double CObjetoRedePercolacao_Final::Go ( long double /*d */ )
{
