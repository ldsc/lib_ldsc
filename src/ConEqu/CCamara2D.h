 ...
 * Esta classe é herdeira da classe CMatriz2D, ou seja, uma camara é uma imagem
...
*/
class CCamara2D : public CCamara, public CMatriz2D
{
  //  Métodos
  public:
  ...
  //  CCamara2D (CMatriz2D*& img,int raioMaximo=10):CCamara(raioMaximo)
  //  {
  ...
  //  { return (  (CMatriz2D2D::operator== (aCCamara2D))   );  };
  ...
  virtual CMatriz2D * CriaCamara ( CMatriz2D * &img );	//  ,int raioMaximo=10);
  
  //  virtual CMatriz2D* CriaCamara(const CMatriz2D*& const img);
  ...
  virtual void DefineImagem (CMatriz2D * &img);
};
