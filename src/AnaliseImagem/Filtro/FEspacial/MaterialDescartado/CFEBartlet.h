...
Descri��o:           Cria e utiliza uma m�scara pseudo-gaussiana para atuar sobre a imagem.
                     O filtro de bartlet se equivale a aplica��o do filtro passa alta duas vezes.
                     (confirmar?)
