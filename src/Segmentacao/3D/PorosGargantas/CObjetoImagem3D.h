#ifndef CObjetoImagem3D_h
#define CObjetoImagem3D_h
...
class CObjetoImagem3D
{
	public:
		// ---------------------------------------------------Construtor-Destrutor
		/// Construtor
		CObjetoImagem3D(): tipo( NAO_IDENTIFICADO ), rotulo(0), sConeccao()
		{};

		/// Construtor sobrecarregado
		CObjetoImagem3D( ETipoObjetoImagem _t , int _r) 	// std::vector< int > _v = 0 )
