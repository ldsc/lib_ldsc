...
//Funcao que procura e elimina p�s de galinha
...
////////Quando um ponto � o final da linha, deve ser marcado como inapagavel= valorEsqueleto+1
////////
////////S� USAR PARA ELIMINAR OS PES DE GALINHA< COMO ESQUELETO NAO FUNCIONA
///////////////////////////////////////////////////////////////////
  pm = imagem;
  int nx = pm->GetNX ();
  int ny = pm->GetNY ();
