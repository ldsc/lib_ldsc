...
//Bibliotecas LDSC
//------------------------------------------------------------------
#include    "AnaliseImagem/Filtro/FFrequencial/FFT/CFFT.h"	//classe
...
#include <AnaliseImagem/Filtro/FFrequencial/FFT/FuncoesAuxiliaresParaCFFT.h>	/* inclue definição das funções */
#endif
