#ifndef CAberturaDilatacaoNew_H
#define CAberturaDilatacaoNew_H
...
class CAberturaDilatacaoNew
{
	...
	public:
		/// Construtor
		CAberturaDilatacaoNew();

		/// Construtor sobrecarregado
		CAberturaDilatacaoNew(TCMatriz2D< int >* &matriz, std::string _nomeImagem = "", int _indice=1, int _fundo=0);
