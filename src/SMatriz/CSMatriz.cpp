...
// -----------------------------------------------------------------------
double
CSMatriz::Determinante (CMatriz2D * &A)	// ;// , int numRows);
{
/*
...
CMath::EMathError CSMatriz::Inversa (CMatriz2D * &A)	// ;// , int numRows);// MatInverse
{
...
// -----------------------------------------------------------------------
void
CSMatriz::LUBackSubst (CMatriz2D * &A, CVetor * &B)	// ;// CVetor& Index,int A.GetNX(),
{
/*
BUG: a matriz deve ser double e não int
  unsigned int i, j;
...
int rowSwapFlag;
*/
CMath::EMathError CSMatriz::LUDecomp (CMatriz2D * &A)
{
/*
BUG: a matriz deve ser double e não int
