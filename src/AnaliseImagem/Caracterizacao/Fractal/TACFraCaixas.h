...
Superclasse:
Descri��o:          	 Implementa a classe TACFraCaixas.  E'derivada da classe TACFractal.
Acesso:
Cardinalidade:
Abstrata/Concreta:
...
public:
  ...
  //M�todos virtuais herdados                                   //{{TACFraCaixasVIRTUAL_BEGIN}}
protected:

public:
  virtual float CalculaDimensaoFractal (TMatriz2D * &pm);	//calcula dimens�o fractal
  virtual TVetor *CalculaVetorDados (TMatriz2D * &pm);	//calcula vetor de dados

  //{{TACFraCaixasVIRTUAL_END}}
  //M�todos virtuais associados a tabela de resposta de TACFraCaixas
