...
#include "TMascara\TMCDiscreta\CBCEuclidiana.h"
/*
  ============================================================================
...
*/
void  CFMorfologiaMatematica::CriaMascara(unsigned int _tamanhoMascara)
{
...
void   CFMorfologiaMatematica::CriaEEB1(unsigned int /*_tamanhoMascara*/)
{                                       // parametro nao usado
  delete mask;
...
// obs: b1 e b2 poderiam ser lidos do disco
void   CFMorfologiaMatematica::CriaEEB2(unsigned int /*_tamanhoMascara*/)
{                                       // parametro nao usado
  delete mask;
  mask = new CBCEuclidiana(3);
  if(mask)
...
/*
  ...
  Programador:      Andre Duarte Bueno
*/
CMatriz2D *CFMorfologiaMatematica::Erosao (CMatriz2D *& matriz,unsigned int _RaioBola)
{
  pm = matriz;
...
Programador:      Andre Duarte Bueno
*/
CMatriz2D *CFMorfologiaMatematica::Dilatacao(CMatriz2D *& matriz,unsigned int _RaioBola)
{
  pm=matriz;
...
/*
  ...
  Programador:      Andre Duarte Bueno
*/
CMatriz2D *CFMorfologiaMatematica::Fechamento(CMatriz2D *& matriz,unsigned int _RaioBola)
{
  // dilatacao
...
/*
  ...
  Programador:      Andre Duarte Bueno
*/
CMatriz2D* CFMorfologiaMatematica::Abertura(CMatriz2D *& matriz,unsigned int _RaioBola)
{
  // erosao
  Erosao(matriz,_RaioBola);
  // dilatacao
...
CMatriz2D*  CFMorfologiaMatematica::DeteccaoContorno(CMatriz2D*& matriz,unsigned int /*_RaioBola*/)
{
  return matriz;
}
/*
  ...
  Programador:      Andre Duarte Bueno
*/
CMatriz2D*  CFMorfologiaMatematica::HitMiss(CMatriz2D*& matriz,unsigned int /*_RaioBola*/)
{
  /*        CMatriz2D* matriz2=new CMatriz2D(matriz);       // Cria copia da matriz
	    ...
	    CFMorfologiaMatematica::Erosao(matriz,_RaioBola);// Erosão sobre a matriz com Bi
	    EEHitMiss2=true;                       // ativa criação da mascara para be
	    CFMorfologiaMatematica::Erosao(matriz2,_RaioBola);// Erosão sobre a matriz2 com be
	    matriz->Intersecao(matriz2);                              // intersecção entre matriz e matriz2
	    delete matriz2;
  */
  return matriz;
}
CMatriz2D*  CFMorfologiaMatematica::Afinamento(CMatriz2D*& matriz,unsigned int /*_RaioBola*/)
{
 /*
    CMatriz2D* matriz2=new CMatriz2D(matriz);      // Cria copia da matriz
...
CMatriz2D*  CFMorfologiaMatematica::Espessamento(CMatriz2D*& matriz,unsigned int /*_RaioBola*/)
{  /*
     CMatriz2D* matriz2=new CMatriz2D(matriz);       // Cria copia da matriz
     HitMiss(matriz2,  _RaioBola);                // Realiza operação HitMiss
...
CMatriz2D*  CFMorfologiaMatematica::Esqueleto(CMatriz2D*& matriz,unsigned int /*_RaioBola*/)
{
  return matriz;
}
