...
/*
  ...
  Nome deste arquivo:	CFMMIDFd34.cpp
  Nome da classe:      CFMMIDFd34
  Arquivos de documentacao do projeto em: path\documentacao\*.doc, path\Help
  Descricao:	 Implementa a fun��o CriaMascara da classe CFMMIDFd34.
*/
...
#include "TFiltro\TFEspacial\TFEMorfologiaMatematica\CFMMIDFd34.h"	// Classe base
// #include "TMascara\TMCDiscreta\TMCd34.h"              // ponteiro para
...
*/
/*
// CMatriz2D * CFMMIDFd34::Go(CMatriz2D * matriz )
CMatriz2D *CFMMIDFd34::Go( CMatriz2D *& matriz, unsigned int _tamanhoMascara )
{
