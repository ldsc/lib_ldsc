...
// ----------------------------------------------------------------Matodos
   ...
   static void TestaAlocacao ( void* ptr, std::string s ); // == assert?
   ...
   // Cabeçalho para programas demo da LIB_LDSC
   static void Cabecalho_ProgramasDemo_LIBLDSC ( std::ostream& os );
