...
#include <Tiltro/FEspacial3D/FEMorfologiaMatematica3D/CFEMMIDF3D.h>
...
CFEMMIDFdijk3D (TMatriz3D * &matriz, unsigned int _mi, unsigned int _mj, unsigned int _mk, unsigned int _rb)
