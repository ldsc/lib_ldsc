...
Superclasse:         ---
Descri��o:           Declara a classe TACFractal.
Acesso:
Cardinalidade:
Abstrata/Concreta:
...
public:
  ...
  //M�todos virtuais herdados                                   //{{TACFractalVIRTUAL_BEGIN}}
protected:
public:
  ...
  };				//retorna a dimens�o fractal
  //{{TACFractalVIRTUAL_END}}
  //M�todos virtuais associados a tabela de resposta de TACFractal
