...
// ===============================================================================
// Documentacao da  @class CGrafo_3Dby2D
// ===============================================================================
/**
 ...
 * @ingroup  HCGrafo
*/
class CGrafo_3Dby2D : public CGrafoContorno {
     // --------------------------------------------------------------Atributos
private:
...
public:
     // -------------------------------------------------------------Construtor
     /// Construtor, recebe um nome de arquivo; só se for chamado CGrafo_3Dby2D{string};
     explicit CGrafo_3Dby2D ( std::string _nomeArquivo )
...
public:
     ...
     // -----------------------------------------------------------------Friend
     //       friend ostream& operator<< (ostream& os, CGrafo_3Dby2D& obj);
     //       friend istream& operator>> (istream& is, CGrafo_3Dby2D& obj); //  Public attributes
};

// -----------------------------------------------------------------Friend
// Declaração de Funções Friend
// ostream& operator<< (ostream& os, CGrafo_3Dby2D& obj);
// istream& operator>> (istream& is, CGrafo_3Dby2D& obj);
#endif
