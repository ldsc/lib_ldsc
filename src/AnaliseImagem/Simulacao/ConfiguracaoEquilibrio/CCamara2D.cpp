...
--------------------------------------------------------------------------*/
#include <AnaliseImagem/Simulacao/ConfiguracaoEquilibrio/CCamara2D.h>
 ...
 * @return *CCamara2D
 */
TCMatriz2D< int > *CCamara2D::CriaCamara ( TCMatriz2D< int > * &img )
{
  ...
  // caso afirmativo, deletar, e setar com nullptr
	data2D.clear();
	AlocaMatriz2D(nx,ny);
 ...
 */
void CCamara2D::DefineImagem (TCMatriz2D< int > * &img)
{
