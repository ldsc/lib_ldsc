...
// -------------------------------------------------------------Construtor
/// Construtor
     CGrafo_3Dby2D_M4 ( std::string _nomeArquivo ) :CGrafo_3Dby2D_M3 ( _nomeArquivo )  {
          tipoGrafo  =  ETipoGrafo::grafo3DBy2D_M4;
     }

// --------------------------------------------------------------Destrutor
/// Destrutor
     virtual ~ CGrafo_3Dby2D_M4 () = default;
...
protected:
     ...
     // A funcao void CGrafo_3Dby2D::EliminarObjetosRedundantes()
...
// --------------------------------------------------------------------Set
// -----------------------------------------------------------------Friend
//       friend ostream& operator<< (ostream& os, CGrafo_3Dby2D_M4& obj);
//       friend istream& operator>> (istream& is, CGrafo_3Dby2D_M4& obj);
};

// -----------------------------------------------------------------Friend
// Declaração de Funções Friend
// ostream& operator<< (ostream& os, CGrafo_3Dby2D_M4& obj);
// istream& operator>> (istream& is, CGrafo_3Dby2D_M4& obj);
