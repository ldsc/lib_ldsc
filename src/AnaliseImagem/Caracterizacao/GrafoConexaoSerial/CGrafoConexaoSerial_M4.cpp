 ...
 *	Redefinida em CGrafoConexaoSerial_M4, para armazenar a informação
 *	cmx e cmy do objeto.
   ...
   CContorno::ETipoContorno tipoContornoObjeto)
{
  ...
  CGrafoConexaoSerial::AdicionarObjetos (rotulador, ultimoRotuloUtilizado, tipoContornoObjeto);
...
*/
/*
void  CGrafoConexaoSerial_M4::CalcularCentroMassa()
{
...
*/
void
CGrafoConexaoSerial_M4::CalcularCondutancias
...
void
CGrafoConexaoSerial_M4::Write ( std::ofstream out )
{
  out.setf (ios::right);
